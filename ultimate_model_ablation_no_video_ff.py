...
TEACHER_ORDER = ["frame_dfdc", "frame_diff", "audio_lavdf"]
...
RESUME_CKPT_PATH = "/kaggle/input/models/syedazmulhasansabbir/ultimate-model-last-checkpoint-no-video-ff/tensorflow2/default/1/last_checkpoint.pth"
FORCE_RESTART_CURRENT_EPOCH = True
BEST_CKPT_RESUME_INPUT_PATH = "/kaggle/input/models/syedazmulhasansabbir/ultimate-model-auc-no-video-ff/tensorflow2/default/1/best_auc.pth"
BEST_EMA_CKPT_RESUME_INPUT_PATH = "/kaggle/input/models/syedazmulhasansabbir/ultimate-model-auc-no-video-ff/tensorflow2/default/1/best_auc.pth"
